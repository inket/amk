...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0]=LAYOUT_default(
		...
		LT(2, MY_CUSTOM_CAPS),  KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT,          KC_ENT, KC_PGUP,
		KC_LSFT, KC_GRV, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_UP, KC_PGDN,
		KC_LCTL, UNSTUCK_LALT, KC_LGUI,                 SAFE_SPACE,               KC_RGUI, UNSTUCK_RALT ,KC_LEFT, KC_DOWN, KC_RGHT),

	[1]=LAYOUT_default(
		KC_NUBS, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_F24,
		...
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_VOLU, KC_SCROLL_LOCK,
		KC_TRNS, KC_TRNS, KC_TRNS,                            KC_MPLY,                            KC_TRNS, KC_TRNS, KC_MRWD, KC_VOLD, KC_MFFD),
	...
	[2]=LAYOUT_default(
		...
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,          KC_TRNS, KC_PAUS,
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_VOLU, KC_SCROLL_LOCK,
		KC_TRNS, KC_TRNS, KC_TRNS,                            SPACE_INDENTATION,                KC_TRNS, KC_TRNS, KC_MRWD, KC_VOLD, KC_MFFD),
};
